...
class Exam_eucl_space:
    def __init__(self):
        self.questions_1 = [
            ...
            ["What is the operator associated with a rotation matrix that define the Special orthogonal group?",
             "Quelle opération associée à une matrice de rotation permet de définir le groupe orthogonal spécial ?"],
            ["What is the operator associated with a rotation matrix that define the Special Euclidean group?",
            ...
            ["What is the difference between an intrinsic and an extrinsic rotation?",
             "Quel est la différence entre une rotation une rotation intrinsèque et extrinsèque ?"],
            ["Give an advantage of rotation matrix over other rotation representation.",
             "Donnez un avantage des matrices de rotation par rapport aux autres représentation des rotations."],
            ["Give a disadvantage of rotation matrix over other rotation representation.",
             "Donnez un désavantage des matrices de rotation par rapport aux autres représentation des rotations."],
            ["Give an advantage of quaternion over other rotation representation.",
             "Donnez un avantage des quaternions par rapport aux autres représentation des rotations."],            
            ["Give a disadvantage of quaternion over other rotation representation.",
             "Donnez un désavantage des quaternions par rapport aux autres représentation des rotations."],
            ["What is the link between a rotation matrix and a reflexion matrix?",
             "Quel est le lien entre une matrice de rotation et une matrice de réflection ?"],
        ...
        self.questions_2 = [
            ...
            ["Give an advantage of Euler angles over other rotation representation.",
             "Donnez un avantage de la représentation des angles d'Euler par rapport aux autres représentation des rotations."], 
            ["Give a disadvantage of Euler angles over other rotation representation.",
             "Donnez un désavantage de la représentation des angles d'Euler par rapport aux autres représentation des rotations."],
            ["Give an advantage of axis-angle representation over other rotation representation.",
             "Donnez un avantage de la représentation axe-angle par rapport aux autres représentation des rotations."],
            ["Give a disadvantage of axis-angle representation over other rotation representation.",
             "Donnez un désavantage de la représentation axe-angle par rapport aux autres représentation des rotations."],
        ...
        self.questions_3 = [
            ...
            ["What format would have a point cloud that needs to be transformed by a matrix in $\SE{3}$ using a single matrix multiplication?",
             "Quel format aurait un nuage de point devant être transformé par un matrice faisant partie de $\SE{3}$ en utilisant une seule multiplication matricielle ?"],
